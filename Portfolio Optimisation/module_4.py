...
#     check_df = fs_final[(fs_final['Year']==year_1) | (fs_final['Year']==year_2)]
    ...
    fs_final['Industry'] = bse_ticker['Industry'].loc[z].values

    
    # Remove Percentage 
    remove_percentage_function(fs_final)
    # Convert Columns to Integers
    column_type_convertor(fs_final)
    fs_final['Debt/Asset'] = (fs_final['Borrowings']+fs_final['Other_Liabilities'])/(fs_final['Total Assets'])
    fs_final['Other Income/Total Revenue'] = fs_final['Other_Income']/fs_final['Sales']
    fs_final['Other Liabilities/Total Liabilities'] = fs_final['Other_Liabilities']/fs_final['Total Liabilities']
    fs_final['Investment/Total Assets'] = fs_final['Investments']/fs_final['Total Assets']
